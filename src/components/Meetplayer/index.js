...
import informateurs from "../../assets/Pictures/Role/informateur Blue.png";
import Joueurs from "../../assets/Pictures/Role/joueur Blue.png";
import Pierre from "../../assets/Pictures/Symbole/pierre_bleu.png";
import Feuille from "../../assets/Pictures/Symbole/feuille_bleu.png";
import Ciseau from "../../assets/Pictures/Symbole/ciseaux_bleu.png";
 ...
 */
 ...
 // **************************************Gestion de l'affichage de l'hote ou du participant ***********************************
  ...
  const pseudoValueInvite = (event) => {
    ...
    //ternaire pour check nb de characteres + 10
        ...
        <div className="responsiveAlert" >!!!!!!!!!!Responsive in progress!!!!!!!!!!</div>
          ...
          <div className="div__section-principal--inviter--joueur">
            ...
            <div className="contenerNonHote">
              ...
              <form className="formeNameNonHote" type="text">
                <input
